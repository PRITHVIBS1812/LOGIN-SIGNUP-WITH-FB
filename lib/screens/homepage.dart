...
import 'package:newlogin/screens/custombuttons.dart';
  ...
  Widget build(BuildContext context) {
    ...
    final search=TextFormField(
      ...
      decoration: InputDecoration(
          ...
          prefixIcon:Icon(Icons.search,color: Color.fromRGBO(77,0,114,1),),
          contentPadding: EdgeInsets.fromLTRB(20,15,20,15),
          hintText: "Search",
          hintStyle: TextStyle(fontFamily: 'Arimo'),
          suffixIcon: Icon(Icons.filter_alt,color: Color.fromRGBO(77,0,114,1),),
