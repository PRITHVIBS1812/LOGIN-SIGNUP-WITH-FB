...
class asBlock extends StatefulWidget {
  ...
  @override
  State<asBlock> createState() => _asBlockState();
}
class _asBlockState extends State<asBlock> {
  @override
  Query dbRef = FirebaseDatabase.instance.ref().child('ASCLASS');
        ...
        child: Column(
          ...
          children: [
            if(request['CLASS-TYPE']=='Classroom')
                asclass(request['CLASS-NAME'], request['STRENGTH'], request['SPEAKER-PROJECTOR'], request['AC']),
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(title: Text("AS BLOCK",style: TextStyle(fontFamily: 'Arimo',color: Colors.white,fontSize:15,fontWeight: FontWeight.bold),),
        centerTitle: true,
  ...
  Material asclass(String classnum,String strength,String speakerAndprojector,String ac) {
    return Material(
      elevation: 4,
      color: Colors.white,
