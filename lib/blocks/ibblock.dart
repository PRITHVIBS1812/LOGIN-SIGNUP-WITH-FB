...
class ibBlock extends StatefulWidget {
  ...
  @override
  State<ibBlock> createState() => _ibBlockState();
}

class _ibBlockState extends State<ibBlock> {
  @override
  Query dbRef = FirebaseDatabase.instance.ref().child('IBCLASS');
        ...
        child: Column(
          ...
          children: [
            if(request['CLASS-TYPE']=='Classroom')
              ibclass(request['CLASS-NAME'], request['STRENGTH'], request['SPEAKER-PROJECTOR'], request['AC']),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(title: Text("IB BLOCK",style: TextStyle(fontFamily: 'Arimo',color: Colors.white,fontSize:15,fontWeight: FontWeight.bold),),
        centerTitle: true,
  ...
  Material ibclass(String classnum,String strength,String speakerAndprojector,String ac) {
    return Material(
      elevation: 4,
      color: Colors.white,
