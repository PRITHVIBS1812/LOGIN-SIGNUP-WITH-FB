...
class _libState extends State<lib> {
        ...
        child: Column(
          ...
          children: [
            if(request['CLASS-TYPE']=='Conference Hall')
              conferencehall(request['CLASS-NAME'], request['STRENGTH'], request['SPEAKER-PROJECTOR'], request['AC']),
          ],
        ),
      ),
    );
  ...
  Material conferencehall(String classnum1,String strength1,String speakerAndprojector1,String ac1) {
    return Material(
      elevation: 4,
      color: Colors.white,
